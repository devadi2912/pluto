            ...
            {!isEditing && (
              <div className="p-8 pt-0 grid grid-cols-2 gap-5">
                ...
                <button 
                  onClick={handleFetch}
                  disabled={isFetching}
                  className={`flex items-center justify-center gap-3 py-5 rounded-2xl font-black text-[11px] uppercase tracking-[0.2em] transition-all active:scale-95 border-4 ${
                    isFetching 
                      ? 'bg-zinc-400 border-zinc-100 dark:border-zinc-800 cursor-not-allowed text-white' 
                      : 'bg-orange-500 text-white border-white dark:border-zinc-950 shadow-[0_15px_30px_rgba(249,115,22,0.4)] hover:brightness-110'
                  }`}
                >
